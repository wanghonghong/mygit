...
<div class="m-tab f-mb-m">
    <ul id="memutab">
        ...
        <li class="" data-target="authorizeBox">微博授权</li>
    </ul>
</div>
<div>
    <div id="memusetBox">
        ...
        <div id="dialoginfo" class="dialoginfo dhk">
            <div class="select dialog-js">
                <div class="dialog-jstxt1"><span>根据您所经营行业，系统已将推荐使用的商城主题模板推送到您公众号，请打开微博号查看!</span></div>
                <div class="dialog-jsimg"></div>
                <div class="dialog-jstxt2">因微博号可能授权延时，建议您先取消关注，再关注，便可快速看到微博号新菜单、主题商城。</div>
...
<script src="${STATIC_URL}/js/busi-js/pc/menu/wb/wb_menu-settings.js"></script>
