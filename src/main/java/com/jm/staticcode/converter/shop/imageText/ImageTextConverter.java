    ...
    public static PageItem<ImageTextRos> toShopResourceRos(Page imageTextpage) {
        ...
        if(0<imageTextList.size()){
            for (Object object:imageTextList) {
                ...
                imageTextRos.setStatus(Toolkit.parseObjForInt(imageText.getStatus()));
                ...
                imageTextRos.setEditionSign(imageText.getEditionSign());
                imageTextRos.setArticleType(imageText.getArticleType());
                imageTextRos.setIsEdit(imageText.getIsEdit());
