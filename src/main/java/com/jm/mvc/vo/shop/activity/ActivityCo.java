...
public class ActivityCo {
    ...
    @ApiModelProperty("活动类型 1:现金红包 2：优惠卷红包 3：红包墙  4：天天红包 5：聚客红包")
    ...
    private ActivityConditionCo activityConditionCo;

    private List<ActivitySubCo> subActivityList;

    private List<ActivityCardCo> activityCardList;
