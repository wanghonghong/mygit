...
public class ImageTextCo {
    @Data
    public class ImgTextCo{
        @ApiModelProperty("版式选择 /1:仿微信页 2：自由编辑 3：h5 4:自定义H5(新)")
    ...
    private ImgTextCo imgTextCo;
    private List<ImageTextRelateCo>  imageTextRelateList ;
