var GoodsDialog = function(options, callback) {
	this.default={
		pageSize:10,
		curPage: 0,
		width:800,
...
GoodsDialog.prototype = {
	...
	ajaxConfig: {
		RenderMap: '/good/productList/0'
	},
	_renderHtml:function(){
		this.$table=$("<div>",{
			"class":"m-jm-table goods-table clearfix",
	...
	_renderData:function(data,sign){
		...
		$.each(items, function(i) {
			...
			$("<img />",{
				"src":items[i].pic_square||"./css/img/pc/no_picture.png"
