 ...
 * 官方图文
 */
CommonUtils.regNamespace("op", "enjoygraphic");
op.enjoygraphic = (function(){
    var count = 3;
    var sumH5img = 0;
    var ajaxUrl = {
    ...
    var _refreshPage = function( id ){
        var url = ajaxUrl.url1+'/findAll/2';
        ...
        $.ajaxJson(url,params,{
            "done":function(res){
                if(res.code===0){
                    ...
                    jumi.template('op/lx_list_img',data,function(tpl){
                        $('#table-body').empty();
                        $('#table-body').html(tpl);
                    })
                }
        ...
        $('#op_more_link').click(function(){
            ...
            menuDialog.Menu.initPage({
                ...
                menu.getUrl(function(link){
                    ...
                    element.parent().find('input[name="op_edit_address"]').val(url);
                    element.parent().find('input[name="op_edit_address"]').attr('disabled',true);
                });
            });
        })
        ...
        $('#op_set_btn_one,#op_set_btn_two').click(function(){
            ...
            menuDialog.Menu.initPage({
                ...
                menu.getUrl(function(link){
                    ...
                    element.parent().find('input[name="op_btn_link"]').attr('disabled',true);
                });
            });
        })
        $('i[id^="del_img_"]').click(function(){
    ...
    var _bind = function(){
        ...
        $('#op_btn_del_one,#op_btn_del_two').click(function(){
            ...
            $(this).parent().find('input[name="op_btn_link"]').val('');
            $('input[name="op_btn_link"]').attr('disabled',false);
        })
        $('#op_del').click(function(event){
            event.stopPropagation();
            $('input[name="op_video_s"]').val('');
        ...
        $('#op_save').click(function () {
            ...
            if (form.valid()) {
                ...
                jumi.dialogSure('确定保存该乐享图文的信息吗?',args);
            } else {
                $('body').animate({scrollTop:0},1000);
            }
        })
        ...
        $('input[name="image_showFormat"]').click(function(){
            ...
            var url = ajaxUrl.url2+'/saveShowFormat/'+value+'/type_id/2';
            $.ajaxJsonPut(url,'',{
                "done":function (res) {
                    if(res.code===0){
                        var dm = new dialogMessage({
        ...
        $('#op_tab').find('li').unbind('click').bind('click',function(){
            ...
            if(index === 1){
                ...
                var url = ajaxUrl.url2+'/list/type_id/2';
                var params = {
                    pageSize:10
                };
                jumi.pagination('#pageTypeToolbar',url,params,function(res,curPage){
                    if(res.code===0){
                        ...
                        jumi.template('op/lx_list_type',data,function(tpl){
        ...
        $('#op_content').on('click','i[id^="del_img_"]',function(){
            $(this).parent().remove();
        })
            ...
            $.ajaxJsonGet(url,"",{
                "done":function (res) {
                    if(res.code===0){
                        ...
                        jumi.template('op/lx_edit_img',data,function(tpl){
                            var d = dialog({
                                title: '图文编辑',
                                content:tpl,
                                width:1200,
    ...
    var _initImageType = function(){
        jumi.template('op/index',function(html){
            ...
            var str =[];
            var url = ajaxUrl.url2+'/type_id/2';
