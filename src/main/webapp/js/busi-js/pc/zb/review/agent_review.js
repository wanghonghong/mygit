 ...
 * 官方图文
 */
CommonUtils.regNamespace("agent", "review");
agent.review = (function(){
    ...
    var _bind = function(){
        ...
        jumi.pagination('#agentToolbar1',url,params,function(res,curPage){
            if(res.code===0){
                var data = {
                    items:res.data.items
                };
                jumi.template('zb/review/agent_review_list',data,function(tpl){
                    $('#agentReviewList1').html(tpl);
                })
            }
        })
        ...
        $('#m-tab').find('li').click(function(){
            ...
            if(index==='2'){
                ...
                jumi.pagination('#agentToolbar2',url,params,function(res,curPage){
                    if(res.code===0){
                        var data = {
                            items:res.data.items,
                            index:2
            ...
            if(index==='3'){
                ...
                jumi.pagination('#agentToolbar3',url,params,function(res,curPage){
                    if(res.code===0){
                        var data = {
                            items:res.data.items,
                            index:3
        ...
        $('[id^=agentReviewList]').on('click','#delete_btn',function(){
            var args = {};
        ...
        $('[id^=agentReviewList]').on('click','div[id^="reviewbutton_"]',function(){
            var self = $(this);
            ...
            $.ajaxJson(url,data,{
                "done":function (res) {
                    ...
                    jumi.template('zb/review/agent_review_dialog',data,function (tpl) {
                        var d = dialog({
                            title: '审核操作',
                            content:tpl,
                            width:900,
