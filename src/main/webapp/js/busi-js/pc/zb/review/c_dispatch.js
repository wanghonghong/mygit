 ...
 * 总部派单
 */
CommonUtils.regNamespace("c_dispatch", "review");
c_dispatch.review = (function(){
    var ajaxUrl = {
    ...
    var _bind = function(){
        ...
        $(".dialog-addorder").click(function() {
            jumi.template('zb/review/c_dispatch_save_dialog',function (tpl) {
                var d =dialog({
                    title: "创建工单",
                    content: tpl,
                    onshow:function () {
        ...
        jumi.pagination('#dispatchToolbar',url,params,function(res,curPage){
            if(res.code===0){
                ...
                jumi.template('zb/review/c_dispatch_list',data,function(tpl){
        ...
        $('#dispatchList').on('click','div[id^="dispatch_"],div[id^="change_dispatch_"]',function(){
            ...
            $.ajaxJson(url,dispatchId, {
                "done": function (res) {
                    ...
                    jumi.template('zb/review/c_dispatch_select_dialog',data,function (tpl) {
                        var d = dialog({
                            title: '派单操作',
                            id:'dispatchDialog',
                            content:tpl,
                            ...
                            onshow:function () {
                                ...
                                jumi.pagination('#joinPageToolbar',url,params,function(res,curPage){
                                    if(res.code===0){
                                        ...
                                        jumi.template('zb/review/c_dispatch_join_list',data,function(tpl){
                                            $('#joinList').html(tpl);
                                        })
                                    }
                                })
                                ...
                                $('#joinList').on('click','label[id^="label_"]',function() {
                                    ...
                                    jumi.template('zb/review/c_dispatch_last_dialog', data, function (tpl) {
                                        var d = dialog({
                                            title: '操作提醒',
                                            content: tpl,
                                            width: 400,
                                            onshow: function () {
                                                ...
                                                $('#sure1').click(function(){
                                                    ...
                                                    dispatchHistory.companyName = companyName;
                                                    dispatchHistory.phoneNumber = phoneNumber;
        ...
        $('#dispatchList').on('click','div[id^="search_"]',function(){
            ...
            $.ajaxJson(url,data, {
                "done": function (res) {
                    ...
                    jumi.template('zb/review/c_dispatch_search_dialog',data,function (tpl) {
                        var d = dialog({
                            title: '查看操作',
                            content:tpl,
                            width:1015,
        ...
        $('#dispatchList').on('click','div[id^="check_dispatch_"]',function(){
            ...
            $.ajaxJson(url,datas, {
                "done": function (res) {
                    ...
                    jumi.template('zb/review/c_dispatch_review_dialog',data,function (tpl) {
                        var d = dialog({
                            title: '审核操作',
                            content:tpl,
                            width:1030,
