 ...
 * 官方图文
 */
CommonUtils.regNamespace("agent", "class");
agent.class = (function(){
    ...
    var _bind = function(){
        ...
        jumi.pagination('#agentToolbar', url, params, function (res, curPage) {
            if (res.code === 0) {
                var data = {
                    items: res.data.items
                };
                jumi.template('zb/user/agent_class_list', data, function (tpl) {
                    $('#agentClassList').html(tpl);
                })
            }
        });
        ...
        //点击查看按钮
        $('#agentClassList').on('click','.lookShop',function(){
            var data = {};
            data.globalUrl = THIRD_URL;
            jumi.template('zb/user/agent_class_shop',data,function (tpl) {
                var d = dialog({
                    title: '　',
                    content:tpl,
                    width:900,
        ...
        //点击编辑按钮
        $('#agentClassList').on('click','.edit',function(){
            var self = $(this);
        ...
        var _classDialog = function (data) {
            jumi.template('zb/user/agent_class_dialog',data,function (tpl) {
                var d = dialog({
                    title: '　',
                    content:tpl,
                    width:900,
