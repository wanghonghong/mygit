CommonUtils.regNamespace("customer", "newbuy");
var curPage = 0 ;
customer.newbuy = (function(){
    var count = 3;
    var ajaxUrl = {
    ...
    var _queryList = function(curPage,reval){
        ...
        var tpurl = "";
        if(platform == 0){
            url = ajaxUrl.url1+'/findAll/3';
            tpurl = "new_customer/buy_list";
            $("#platformFont").text("微信");
        }else{
            url = ajaxUrl.url1+'/findAllwb/4';
            tpurl = "new_customer/wb/buy_list";
