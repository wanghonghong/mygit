CommonUtils.regNamespace("customer", "newsub");
var curPage = 0 ;
customer.newsub = (function(){
    var count = 3;
    var ajaxUrl = {
    ...
    var _queryList = function(curPage,reval){
        ...
        var platform=$("#select4D option:selected").val();//平台
        if(platform == 1){
        ...
        var sex=$("#select3D option:selected").val();
