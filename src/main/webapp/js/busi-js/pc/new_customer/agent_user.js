CommonUtils.regNamespace("customer", "agentuser");
var curPage = 0 ;
customer.agentuser = (function(){
    var ajaxUrl = {
    ...
    var _queryList = function(curPage,reval){
        //查询等级列表
        var levels;
        ...
        var agentRole=$("#select4 option:selected").val();
        ...
        var tpurl = "";
        if(platform == 0){
            url = ajaxUrl.url1+'/findAll/5';
            tpurl = "new_customer/agent_user_list";
            $("#platformFont").text("微信");
        }else{
            url = ajaxUrl.url1+'/findAllwb/6';
            tpurl = "new_customer/wb/agent_user_list";
