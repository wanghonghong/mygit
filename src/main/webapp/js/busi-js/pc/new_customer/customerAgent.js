CommonUtils.regNamespace("customer", "newagent");
var curPage = 0 ;
customer.newagent = (function(){
    var count = 3;
    var ajaxUrl = {
    ...
    var _queryList = function(curPage,reval){
        ...
        var tpurl = "";
        if(platform == 0){
            url = ajaxUrl.url1+'/findAll/4';
            tpurl = "new_customer/agent_list";
            $("#platformFont").text("微信");
        }else{
            url = ajaxUrl.url1+'/findAllwb/5';
            tpurl = "new_customer/wb/agent_list";
